...
>**Важно, что** в настоящее время Машинное обучение Azure Studio не поддерживает тип создания набора данных, необходимого для использования тестирования развертывания. Мы обновим вас, когда есть разрешение. 
