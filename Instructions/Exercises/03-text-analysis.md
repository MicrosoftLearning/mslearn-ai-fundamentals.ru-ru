...
1. На странице "Игровые площадки Azure AI Foundry" выберите " **Попробовать языковую площадку**". Языковая площадка — это пользовательский интерфейс, который позволяет попробовать некоторые возможности языка искусственного интеллекта Azure.  
