...
1. В ресурсе рабочей области Машинное обучение Azure выберите **"Запустить студию**" (или откройте новую вкладку браузера и перейдите к ней и войдите [https://ml.azure.com](https://ml.azure.com?azure-portal=true)в Студия машинного обучения Azure с помощью учетной записи Майкрософт). Закройте все отображаемые сообщения.
...
1. Создайте новое задание автоматизированного машинного обучения со следующими параметрами, используя кнопку **Далее** по мере необходимости для продвижения по пользовательскому интерфейсу:
   ...
   **Тип задания и данные**:
    ...
    - **Выберите набор данных**: Создать новый набор данных со следующими параметрами:
        ...
        - **Выбор** MLtable:
            - **** Папка отправки: *скачайте и распакуйте папку, содержащую два файла, которые необходимо отправить.* `https://aka.ms/bike-rentals`
